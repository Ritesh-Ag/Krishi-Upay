...
public class Register extends AppCompatActivity {
    ...
    EditText etName,etNumber,etPassword,etReenter,etEmail;
    Button btnRegister;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etName.getText().toString().isEmpty()|| etPassword.getText().toString().isEmpty()
                        ||etReenter.getText().toString().isEmpty()||etEmail.getText().toString().isEmpty())
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(Register.this,"Password and re entered password are different",Toast.LENGTH_SHORT).show();
                    }
